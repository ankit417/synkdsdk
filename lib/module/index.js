...
import { View, ViewStyle, Dimensions, TouchableOpacity, StyleSheet, Text, Linking, Image, Animated } from 'react-native';
...
const interStitial = function (sKey, tag) {
  ...
  return URL ? /*#__PURE__*/React.createElement(Modal, {
    visible: visible,
    minHeight: 200,
